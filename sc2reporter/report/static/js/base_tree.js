...
function isNumber (o) {
  ...
  */
  function D3BaseTree(element_id,metadata,height,width){
      var self=this;
      this.legend_div=$("<div>").css({"position":"absolute","overflow-x":"hidden"}).css({"top":"0px","right":"0px"});
    //   this.scale_div=$("<div>").css({"position":"absolute","overflow-x":"hidden", "overflow-y":"hidden"}).css({"bottom":"100px","left":"20px"});
